...
if (firstVariant) {
     ...
     if (firstVariantBtn) {
        ...
        // Убедимся, что отображаются данные основного товара
        // (они уже установлены выше, но можно явно вызвать)
        // selectVariantInModal(product, product); // Не нужно, если выше уже установлено
    }
